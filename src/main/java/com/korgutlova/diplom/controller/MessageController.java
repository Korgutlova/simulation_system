...
public class MessageController {
    ...
    public void sendMessage(@DestinationVariable("id") String id, MessageDto message) {
        ...
        //проблема с lazy нужно что-то убрать отсюда, или убрать зависимость
...
//        Conversation conversation = conversationService.getConversation(Long.valueOf(id));
//        if (!parserService.parseMessage(message, conversation)) {
//            ConversationMessage conversationMessage = conversationMessageService.save(message, conversation);
//            simpleMessagingTemplate.convertAndSend(getDestination(conversationMessage),conversationMessage);
//        }
    }
}
